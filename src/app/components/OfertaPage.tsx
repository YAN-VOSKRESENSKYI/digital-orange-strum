  ...
  return (
    ...
    >
      <div style={{ maxWidth: "800px", margin: "0 auto", position: "relative" }}>
        ...
        <h1 style={{ fontSize: "24px", fontWeight: "bold", marginBottom: "20px" }}>Публічна оферта</h1>
        <div style={{ lineHeight: "1.6", color: "#ccc", whiteSpace: "pre-wrap" }}>
          (Текст публічної оферти буде розміщено тут)
          <br /><br />
          Будь ласка, надайте актуальний текст публічної оферти.
        </div>
      </div>
    </div>
  );
